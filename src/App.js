		...
		<Router>
			<div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'linear-gradient(120deg, #1a237e 0%, #6366f1 100%)', fontFamily: 'Inter, Roboto, Arial, sans-serif' }}>
				...
				<header style={{
					...
					<img src={MBJRLogo} alt="MBJR Logo" style={{ height: 60, objectFit: 'contain', background: 'white', borderRadius: 12, boxShadow: '0 2px 8px #1a237e22', padding: 8 }} />
					<div style={{ width: 2, height: 48, background: 'rgba(99,102,241,0.18)', borderRadius: 2 }} />
					...
					<div style={{ width: 2, height: 48, background: 'rgba(99,102,241,0.18)', borderRadius: 2 }} />
					<img src={WMPSCLogo} alt="WMPSC Logo" style={{ height: 44, objectFit: 'contain', background: 'white', borderRadius: 12, boxShadow: '0 2px 8px #1a237e22', padding: 8 }} />
				</header>
